...
setup(name='docassemble.3StPaulMNLimitRentIncrease',
      version='0.0.1',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/3StPaulMNLimitRentIncrease/', package='docassemble.3StPaulMNLimitRentIncrease'),
     )
